...
// Purpose: Verifies app access stays available while Pro access is free.
// Layer: Unit Test
...
final class SubscriptionServiceAccessTests: XCTestCase {
    func testFreshUserHasAppAccess() {
    ...
    func testSendAttemptsAreNotMeteredWhileProAccessIsFree() {
        let service = makeService()
